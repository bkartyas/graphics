 ...
 * @return {Vec1} this
 */
Vec1.prototype.$random = function(minVal, maxVal) {
  var mina = minVal && minVal.x || Number(minVal).valueOf() || 0;
  var maxa = maxVal && maxVal.x || Number(maxVal).valueOf() || 1;  
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$clamp = function(b, minVal, maxVal) {
  var mina = minVal && minVal.x || Number(minVal).valueOf(0) || 0;
  var maxa = maxVal && maxVal.x || Number(maxVal).valueOf(0) || 1;  
  if(b.storage[0] < mina){
    this.storage[0] = mina;
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$add = function(b, c) {
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$sub = function(b, c) {
  this.storage[0] = b.storage[0] - c.storage[0];
  return this;  
};
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$mul = function(b, c) {
  this.storage[0] = b.storage[0] * c.storage[0];
  return this;  
};
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$div = function(b, c) {
  this.storage[0] = b.storage[0] / c.storage[0];
  return this;  
};
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$scale = function(a, s){
 ...
 * @return {Vec1} this
 */
Vec1.prototype.$scaleByInverse = function(a, s){
  this.storage[0] = a.x / s;
  return this;  
}
 ...
 * @return this
 */
Vec1.prototype.$dotOfVec2s = function(b, c) {
 ...
 * @return this
 */
Vec1.prototype.$dotOfVec3s = function(b, c) {
 ...
 * @return this
 */
Vec1.prototype.$dotOfVec4s = function(b, c) {
 ...
 * @return this
 */
Vec1.prototype.$lengthOfVec2 = function(b) {
 ...
 * @return this
 */
Vec1.prototype.$lengthOfVec3 = function(b) {
 ...
 * @return this
 */
Vec1.prototype.$lengthOfVec4 = function(b) {
